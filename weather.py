...
def getCityWeather_RealTime(cityID):
    ...
    try:
        ...
        content = {"城市:":city.encode('utf-8'),temp.encode('utf-8'):"℃ ",fx.encode('utf-8'):fl.encode('utf-8'),"相对湿度":sd.encode('utf-8'),"发布时间:":tm.encode('utf-8')}
...
def main():
    ...
    for city in cityList_bsgs:
        ...
        print type(twitter['message'])
        for i in twitter['message']:
             print i,twitter['message'][i]
